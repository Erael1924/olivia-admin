...
<template>
    <Head title="Update Email Template" />
        ...
        >
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <h2
                        class="text-sm text-gray-600 mb-6 dark:text-neautral-400"
                    >
            ...
            <div class="mb-3">
                ...
                />
                <section class="mb-6">
                    <h2 class="text-sm text-black mb-0 italic dark:text-white">
                        Insert Placeholders
                    </h2>
                    <p
                        class="text-sm text-gray-600 mb-2 italic dark:text-neutral-400"
                    >
